        ...
        >
          <Form className={this.props.formClasses + " my-12 md:my-auto"}>
            ...
            <div>
              {/* redirect */}
              {this.state.redirect && (
                <Navigate to={this.props.redirectOnSuccess} replace={true} />
              )}
              {/* success message */}
              {this.state.response &&
                this.state.responseType === "response" && (
                  <>
                    <AlertText
                      content={this.state.response + ". Redirecting you now..."}
                      type="success"
                    />
                  </>
                )}
              ...
              {this.state.response &&
                this.state.responseType === "serverError" && (
                  <>
              ...
              {this.state.response &&
                this.state.responseType === "networkError" && (
                  <>
                    <AlertText content={this.state.response} type="danger" />
                  </>
                )}
